    ...
    <div className="max-w-full p-8 bg-gray-800 rounded-lg shadow-lg w-96 text-gray-200">
      ...
      <div className="group">
        ...
        <label className="flex items-center h-10 px-2 rounded cursor-pointer hover:bg-gray-900">
          ...
          {/* hidden check[e] */}
          {/* check[s] */}
          <span name="check" className="peer-checked:bg-green-500 peer-checked:border-green-500 peer-checked:text-white flex items-center justify-center w-5 h-5 text-transparent border-2 border-gray-500 rounded-full">
          ...
          <button name="delete" className="hidden group-hover:block">
            <svg className="w-5 h-5 text-gray-400 fill-current mx-1" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 27.965 27.965" xmlSpace="preserve">
      ...
      <div className="flex items-center w-full mt-2">
        ...
        {/* submit button[e] */}
        {/* todo input[s] */}
        {/* #peer/todo 형제가 여러명일 때 별명을 붙여 사용한다. */}
        <input className="peer/todo flex-grow h-8 ml-4 bg-transparent focus:outline-none font-medium" type="text" id="todo" name="todo" required placeholder="add a new todo" />
        {/* todo input[e] */}
        {/* reset button[s] */}
        {/* #peer가 값이 없을 때 숨기기 */}
